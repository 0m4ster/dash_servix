...
def main():
    ...
    page = st.sidebar.selectbox(
        "Escolha a página:",
        ["🏠 Dashboard Principal", "🔐 Gerenciador de Tokens Facta", "📊 Análise de Dados Excel", "🎯 Filtro UTM Source = 'ad'"],
        index=0
    )
    ...
    if page == "🔐 Gerenciador de Tokens Facta":
        ...
        return
    elif page == "📊 Análise de Dados Excel":
        render_excel_analysis_page()
        return
    elif page == "🎯 Filtro UTM Source = 'ad'":
        from excel_filter_ad import render_excel_filter_ad_page
